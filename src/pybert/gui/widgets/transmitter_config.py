...
class TxConfigWidget(QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        """
        super().__init__("Transmitter", parent)
        ...
        rs_layout.addWidget(QLabel("Tx_Rs:"))
        self.rs = QDoubleSpinBox()
        self.rs.setRange(0.0, 200.0)
        self.rs.setValue(50.0)
        self.rs.setSuffix(" Ohms")
        rs_layout.addWidget(self.rs)
        rs_layout.addStretch()
        native_layout.addLayout(rs_layout)

        # Output capacitance
        cout_layout = QHBoxLayout()
        cout_layout.addWidget(QLabel("Tx_Cout:"))
        self.cout = QDoubleSpinBox()
        self.cout.setRange(0.0, 10.0)
        self.cout.setValue(1.0)
        self.cout.setSuffix(" pF")
        cout_layout.addWidget(self.cout)
        cout_layout.addStretch()
        native_layout.addLayout(cout_layout)
