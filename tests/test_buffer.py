...
@patch(
    "pybert.models.buffer.IBISModel.from_ibis_file",
    side_effect=ValueError("Fake Exception Thrown when Reading IBIS Model."),
)
...
@patch(
    "pybert.models.buffer.AMIParamConfigurator",
    side_effect=ValueError("Fake Exception Thrown when Reading AMI Config."),
)
